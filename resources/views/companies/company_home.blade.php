...
<nav class="bg-white border-black-700 dark:bg-gray-500 p-0">
    ...
    <h3 class="p-1 ">Company Management</h3>

    <div class="absolute right-0">
        <button class="border border-gray rounded-md p-1">Assign Extensions</button>
        <button class="border border-gray rounded-md p-1 ml-2 mr-3"data-modal-target="crud-modal" data-modal-toggle="crud-modal">Add Company</button>
    </div>
