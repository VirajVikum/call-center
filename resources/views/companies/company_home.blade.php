...
<nav class="bg-white border-black-700 dark:bg-gray-500 p-0">
    ...
    @livewire('admin.satisfaction-reasons')

    <div class="absolute right-0 mr-8">
        <!-- <button class="border border-gray rounded-md p-1">Assign Extensions</button> -->
        <button onclick="Livewire.dispatch('buttonClicked')" class="border border-gray rounded-md p-1 ml-2 mr-3">Satisfaction Reasons</button>
        <button class="border border-gray rounded-md p-1 ml-2 mr-3">Call Retry Settings</button>
        ...
        @foreach($companies as $company)
            ...
            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    ...
                    <svg class="w-8 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" fill="currentColor"><path d="M396 512a112 112 0 1 0 224 0 112 112 0 1 0-224 0zm546.2-25.8C847.4 286.5 704.1 186 512 186c-192.2 0-335.4 100.5-430.2 300.3a60.3 60.3 0 0 0 0 51.5C176.6 737.5 319.9 838 512 838c192.2 0 335.4-100.5 430.2-300.3 7.7-16.2 7.7-35 0-51.5zM508 688c-97.2 0-176-78.8-176-176s78.8-176 176-176 176 78.8 176 176-78.8 176-176 176z"></path></svg>
</a>
                </td>
                <td class="px-6 py-4">
                <form action="{{route('company.destroy',['company'=>$company])}}" method="post">
                    @csrf
                    @method('delete')
                    <button type="submit" onclick="return confirm('Are you sure you want to delete this company?')"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
